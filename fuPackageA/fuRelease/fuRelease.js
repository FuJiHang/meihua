...
Page({
  ...
  onLoad: function (options) {
    ...
    //   success (f) {
    //     console.log(f.data.access_token)
    //     wx.uploadFile({
    //       url:'https://api.weixin.qq.com/wxa/img_sec_check?access_token='+f.data.access_token,
    //       filePath:'https://file.9oasd.com/bcdj/Storage/master/201907290926438486570.jpg',
    //       name:'media',
    //       success:res=>{
    //           console.log(res)
    ...
    //     })
    //     // wx.request({
    //     //   url: 'https://api.weixin.qq.com/wxa/msg_sec_check?access_token='+f.data.access_token, 
    //     //   method: "POST",
    //     //   data: {
    //     //     content: 'asdasd'
    //     //   },
