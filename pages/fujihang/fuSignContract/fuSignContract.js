...
Page({
  ...
  submit(e) {
    ...
    if (index == 1) {
      // wx.request({
      //   url: app.gethsyurl + '?action=StoreSignContract&openId=oGsqu4qBG6Icub2iLYzI3MJGH4iQ',
      //   data: {
  ...
  onOpen() {
    ...
    wx.request({
      url: app.gethsyurl + '?action=StoreSignContract&openId='+app.globalData.GetMembersInfo.openId,
      data: {
        mobile: data.postList[2].val,
        name: data.postList[0].val,
        id: data.postList[1].val,
        // email: data.postList[2].val,
        area: data.checked,
      ...
      app.getOpenId(function (a) {
        app.fg({
          ...
          if (r.data.Status == "OK") {
            ...
            that.data.postList[0].val = dataR.RealName
            that.data.postList[1].val = dataR.IdentityCard
            // that.data.postList[2].val = dataR.QQ ? dataR.QQ + '@qq.com' : ''
            that.data.postList[2].val = dataR.CellPhone
            that.setData({
