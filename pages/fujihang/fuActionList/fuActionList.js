...
Page({
  ...
  // 
  toFNT(e){
    console.log(JSON.stringify(e.currentTarget.dataset.data),'2222222222' );
    wx.navigateTo({
      url: e.currentTarget.dataset.url+'?data='+JSON.stringify(e.currentTarget.dataset.data)
    })
  },
  ...
  //获取数据 
  getDataR() {
    let type = this.data.type, data = this.data
